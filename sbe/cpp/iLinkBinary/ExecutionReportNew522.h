...
#ifndef _ILINKBINARY_EXECUTIONREPORTNEW522_H_
#define _ILINKBINARY_EXECUTIONREPORTNEW522_H_
...
public:
    ...
    {
        ExecutionReportNew522 skipper(m_buffer, m_offset,
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, ExecutionReportNew522 _writer)
{
    ExecutionReportNew522 writer(_writer.m_buffer, _writer.m_offset,
