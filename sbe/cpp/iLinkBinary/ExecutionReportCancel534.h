...
#ifndef _ILINKBINARY_EXECUTIONREPORTCANCEL534_H_
#define _ILINKBINARY_EXECUTIONREPORTCANCEL534_H_
...
public:
    ...
    {
        ExecutionReportCancel534 skipper(m_buffer, m_offset,
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD ExecReason::Value execRestatementReason() const SBE_NOEXCEPT
    {
        std::uint8_t val;
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, ExecutionReportCancel534 _writer)
{
    ExecutionReportCancel534 writer(_writer.m_buffer, _writer.m_offset,
