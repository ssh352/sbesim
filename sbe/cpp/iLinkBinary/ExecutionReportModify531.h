...
#ifndef _ILINKBINARY_EXECUTIONREPORTMODIFY531_H_
#define _ILINKBINARY_EXECUTIONREPORTMODIFY531_H_
...
public:
    ...
    {
        ExecutionReportModify531 skipper(m_buffer, m_offset,
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, ExecutionReportModify531 _writer)
{
    ExecutionReportModify531 writer(_writer.m_buffer, _writer.m_offset,
