...
#ifndef _ILINKBINARY_CUSTORDERCAPACITY_H_
#define _ILINKBINARY_CUSTORDERCAPACITY_H_
...
public:
    enum Value
    {
        Membertradingfortheirownaccount = (std::uint8_t)1,
        Clearingfirmtradingforitsproprietaryaccount = (std::uint8_t)2,
        Membertradingforanothermember = (std::uint8_t)3,
        Allother = (std::uint8_t)4,
    ...
    static CustOrderCapacity::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            ...
            case 2: return Clearingfirmtradingforitsproprietaryaccount;
            case 3: return Membertradingforanothermember;
    ...
    static const char* c_str(const CustOrderCapacity::Value value)
    {
        switch (value)
        {
            ...
            case Clearingfirmtradingforitsproprietaryaccount: return "Clearingfirmtradingforitsproprietaryaccount";
            case Membertradingforanothermember: return "Membertradingforanothermember";
