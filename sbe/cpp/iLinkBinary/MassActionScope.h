...
#ifndef _ILINKBINARY_MASSACTIONSCOPE_H_
#define _ILINKBINARY_MASSACTIONSCOPE_H_
...
public:
    enum Value
    {
        Instrument = (std::uint8_t)1,
        All = (std::uint8_t)7,
        MarketSegmentID = (std::uint8_t)9,
        InstrumentGroup = (std::uint8_t)10,
        QuoteSetID = (std::uint8_t)100,
