...
#ifndef _ILINKBINARY_ESTABLISHMENTREJECT505_H_
#define _ILINKBINARY_ESTABLISHMENTREJECT505_H_
...
public:
    ...
    {
        EstablishmentReject505 skipper(m_buffer, m_offset,
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, EstablishmentReject505 _writer)
{
    EstablishmentReject505 writer(_writer.m_buffer, _writer.m_offset,
