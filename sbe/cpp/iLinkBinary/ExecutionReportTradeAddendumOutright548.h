...
#ifndef _ILINKBINARY_EXECUTIONREPORTTRADEADDENDUMOUTRIGHT548_H_
#define _ILINKBINARY_EXECUTIONREPORTTRADEADDENDUMOUTRIGHT548_H_
...
public:
    ...
    {
        ExecutionReportTradeAddendumOutright548 skipper(m_buffer, m_offset,
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, ExecutionReportTradeAddendumOutright548 _writer)
{
    ExecutionReportTradeAddendumOutright548 writer(_writer.m_buffer, _writer.m_offset,
