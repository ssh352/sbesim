...
#ifndef _ILINKBINARY_RETRANSMITREJECT510_H_
#define _ILINKBINARY_RETRANSMITREJECT510_H_
...
public:
    ...
    {
        RetransmitReject510 skipper(m_buffer, m_offset,
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, RetransmitReject510 _writer)
{
    RetransmitReject510 writer(_writer.m_buffer, _writer.m_offset,
