...
#ifndef _ILINKBINARY_ORDERTYPEREQ_H_
#define _ILINKBINARY_ORDERTYPEREQ_H_
...
public:
    enum Value
    {
        MarketwithProtection = (char)49,
        Limit = (char)50,
        StopwithProtection = (char)51,
        StopLimit = (char)52,
        MarketWithLeftoverAsLimit = (char)75,
        NULL_VALUE = (char)0
    };
