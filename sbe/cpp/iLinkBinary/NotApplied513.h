...
#ifndef _ILINKBINARY_NOTAPPLIED513_H_
#define _ILINKBINARY_NOTAPPLIED513_H_
...
public:
    ...
    {
        NotApplied513 skipper(m_buffer, m_offset,
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, NotApplied513 _writer)
{
    NotApplied513 writer(_writer.m_buffer, _writer.m_offset,
