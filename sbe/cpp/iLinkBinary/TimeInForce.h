...
#ifndef _ILINKBINARY_TIMEINFORCE_H_
#define _ILINKBINARY_TIMEINFORCE_H_
...
public:
    ...
    {
        Day = (std::uint8_t)0,
        GoodTillCancel = (std::uint8_t)1,
        FillAndKill = (std::uint8_t)3,
        FillOrKill = (std::uint8_t)4,
        GoodTillDate = (std::uint8_t)6,
