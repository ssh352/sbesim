...
#ifndef _ILINKBINARY_REQUESTFORQUOTE543_H_
#define _ILINKBINARY_REQUESTFORQUOTE543_H_
...
public:
    ...
    {
        RequestForQuote543 skipper(m_buffer, m_offset,
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD QuoteTyp::Value quoteType() const SBE_NOEXCEPT
    {
        std::uint8_t val;
    ...
    #pragma clang diagnostic pop
        ...
        SBE_NODISCARD RFQSide::Value side() const SBE_NOEXCEPT
        {
            std::uint8_t val;
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, RequestForQuote543 _writer)
{
    RequestForQuote543 writer(_writer.m_buffer, _writer.m_offset,
    ...
    builder << ", ";
    {
        ...
        writer.noRelatedSym().forEach([&](NoRelatedSym& noRelatedSym)
        {
            if (atLeastOne)
            {
                builder << ", ";
...
void skip()
{
    noRelatedSym().forEach([](NoRelatedSym e)
    {
        e.skip();
    });
}
...
SBE_NODISCARD static SBE_CONSTEXPR_14 size_t computeLength(std::size_t NoRelatedSymLength = 0)
{
#if defined(__GNUG__) && !defined(__clang__)
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wtype-limits"
