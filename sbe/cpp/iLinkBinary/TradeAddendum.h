...
#ifndef _ILINKBINARY_TRADEADDENDUM_H_
#define _ILINKBINARY_TRADEADDENDUM_H_
...
public:
    enum Value
    {
        PartiallyFilled = (std::uint8_t)4,
        Filled = (std::uint8_t)5,
        TradeCancel = (std::uint8_t)100,
        TradeCorrection = (std::uint8_t)101,
