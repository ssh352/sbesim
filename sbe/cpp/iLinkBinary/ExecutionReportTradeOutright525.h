...
#ifndef _ILINKBINARY_EXECUTIONREPORTTRADEOUTRIGHT525_H_
#define _ILINKBINARY_EXECUTIONREPORTTRADEOUTRIGHT525_H_
...
public:
    ...
    {
        ExecutionReportTradeOutright525 skipper(m_buffer, m_offset,
...
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
        return m_actingVersion >= ownershipSinceVersion();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
    }
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, ExecutionReportTradeOutright525 _writer)
{
    ExecutionReportTradeOutright525 writer(_writer.m_buffer, _writer.m_offset,
