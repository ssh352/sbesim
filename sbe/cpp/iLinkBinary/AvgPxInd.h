...
#ifndef _ILINKBINARY_AVGPXIND_H_
#define _ILINKBINARY_AVGPXIND_H_
...
public:
    enum Value
    {
        NoAveragePricing = (std::uint8_t)0,
        TradeispartofanAveragePriceGroupIdentifiedbytheAvgPxGrpID = (std::uint8_t)1,
        TradeispartofaNotionalValueAveragePriceGroup = (std::uint8_t)3,
