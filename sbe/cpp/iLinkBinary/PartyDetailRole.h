...
#ifndef _ILINKBINARY_PARTYDETAILROLE_H_
#define _ILINKBINARY_PARTYDETAILROLE_H_
...
public:
    enum Value
    {
        ExecutingFirm = (std::uint16_t)1,
        CustomerAccount = (std::uint16_t)24,
        TakeUpFirm = (std::uint16_t)96,
        Operator = (std::uint16_t)118,
        TakeUpAccount = (std::uint16_t)1000,
