...
#ifndef _ILINKBINARY_QUOTECXLTYP_H_
#define _ILINKBINARY_QUOTECXLTYP_H_
...
public:
    enum Value
    {
        CancelperInstrument = (std::uint8_t)1,
        CancelperInstrumentgroup = (std::uint8_t)3,
        Cancelallquotes = (std::uint8_t)4,
        CancelperQuoteSet = (std::uint8_t)100,
