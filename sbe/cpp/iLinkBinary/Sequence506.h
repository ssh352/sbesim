...
#ifndef _ILINKBINARY_SEQUENCE506_H_
#define _ILINKBINARY_SEQUENCE506_H_
...
public:
    ...
    {
        Sequence506 skipper(m_buffer, m_offset,
...
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
        return m_actingVersion >= keepAliveIntervalLapsedSinceVersion();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
    }
    ...
    SBE_NODISCARD KeepAliveLapsed::Value keepAliveIntervalLapsed() const SBE_NOEXCEPT
    {
        std::uint8_t val;
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, Sequence506 _writer)
{
    Sequence506 writer(_writer.m_buffer, _writer.m_offset,
