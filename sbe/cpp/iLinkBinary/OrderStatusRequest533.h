...
#ifndef _ILINKBINARY_ORDERSTATUSREQUEST533_H_
#define _ILINKBINARY_ORDERSTATUSREQUEST533_H_
...
public:
    ...
    {
        OrderStatusRequest533 skipper(m_buffer, m_offset,
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, OrderStatusRequest533 _writer)
{
    OrderStatusRequest533 writer(_writer.m_buffer, _writer.m_offset,
