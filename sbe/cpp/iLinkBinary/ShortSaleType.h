...
#ifndef _ILINKBINARY_SHORTSALETYPE_H_
#define _ILINKBINARY_SHORTSALETYPE_H_
...
public:
    enum Value
    {
        LongSell = (std::uint8_t)0,
        ShortSaleWithNoExemptionSESH = (std::uint8_t)1,
        ShortSaleWithExemptionSSEX = (std::uint8_t)2,
        UndisclosedSellInformationNotAvailableUNDI = (std::uint8_t)3,
