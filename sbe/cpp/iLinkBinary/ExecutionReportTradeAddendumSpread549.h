...
#ifndef _ILINKBINARY_EXECUTIONREPORTTRADEADDENDUMSPREAD549_H_
#define _ILINKBINARY_EXECUTIONREPORTTRADEADDENDUMSPREAD549_H_
...
public:
    ...
    {
        ExecutionReportTradeAddendumSpread549 skipper(m_buffer, m_offset,
...
#pragma clang diagnostic pop
    ...
    #pragma GCC diagnostic pop
            ...
            m_bufferLength = bufferLength;
            GroupSize dimensions(buffer, *pos, bufferLength, actingVersion);
            dimensions.blockLength((std::uint16_t)41);
            dimensions.numInGroup((std::uint8_t)count);
            m_index = 0;
            m_count = count;
            m_blockLength = 41;
...
public:
    ...
    #pragma clang diagnostic ignored "-Wtautological-compare"
    #endif
            return m_actingVersion >= legExecRefIDSinceVersion();
    #if defined(__clang__)
    #pragma clang diagnostic pop
    #endif
        }
    ...
    #pragma clang diagnostic ignored "-Wtautological-compare"
    #endif
            return m_actingVersion >= legTradeRefIDSinceVersion();
    #if defined(__clang__)
    #pragma clang diagnostic pop
    #endif
        }
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, ExecutionReportTradeAddendumSpread549 _writer)
{
    ExecutionReportTradeAddendumSpread549 writer(_writer.m_buffer, _writer.m_offset,
