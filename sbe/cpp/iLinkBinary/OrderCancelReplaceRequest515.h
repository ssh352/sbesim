...
#ifndef _ILINKBINARY_ORDERCANCELREPLACEREQUEST515_H_
#define _ILINKBINARY_ORDERCANCELREPLACEREQUEST515_H_
...
public:
    ...
    {
        OrderCancelReplaceRequest515 skipper(m_buffer, m_offset,
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getLocation(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 101, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD OrderTypeReq::Value ordType() const SBE_NOEXCEPT
    {
        char val;
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD OFMOverrideReq::Value oFMOverride() const SBE_NOEXCEPT
    {
        std::uint8_t val;
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, OrderCancelReplaceRequest515 _writer)
{
    OrderCancelReplaceRequest515 writer(_writer.m_buffer, _writer.m_offset,
