...
#ifndef _ILINKBINARY_SECRSPTYP_H_
#define _ILINKBINARY_SECRSPTYP_H_
...
public:
    enum Value
    {
        AcceptSecurityProposalasis = (std::uint8_t)1,
        AcceptSecurityproposalwithrevisionsasindicatedinthemessage = (std::uint8_t)2,
        RejectSecurityProposal = (std::uint8_t)5,
