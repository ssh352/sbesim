...
#ifndef _ILINKBINARY_EXECUTIONREPORTREJECT523_H_
#define _ILINKBINARY_EXECUTIONREPORTREJECT523_H_
...
public:
    ...
    {
        ExecutionReportReject523 skipper(m_buffer, m_offset,
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getLocation(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 420, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
...
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
        return m_actingVersion >= ordRejReasonSinceVersion();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
    }
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, ExecutionReportReject523 _writer)
{
    ExecutionReportReject523 writer(_writer.m_buffer, _writer.m_offset,
