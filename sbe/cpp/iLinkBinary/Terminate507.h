...
#ifndef _ILINKBINARY_TERMINATE507_H_
#define _ILINKBINARY_TERMINATE507_H_
...
public:
    ...
    {
        Terminate507 skipper(m_buffer, m_offset,
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, Terminate507 _writer)
{
    Terminate507 writer(_writer.m_buffer, _writer.m_offset,
