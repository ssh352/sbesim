...
#ifndef _ILINKBINARY_RETRANSMISSION509_H_
#define _ILINKBINARY_RETRANSMISSION509_H_
...
public:
    ...
    {
        Retransmission509 skipper(m_buffer, m_offset,
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, Retransmission509 _writer)
{
    Retransmission509 writer(_writer.m_buffer, _writer.m_offset,
