...
#ifndef _ILINKBINARY_ORDERCANCELREPLACEREJECT536_H_
#define _ILINKBINARY_ORDERCANCELREPLACEREJECT536_H_
...
public:
    ...
    {
        OrderCancelReplaceReject536 skipper(m_buffer, m_offset,
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, OrderCancelReplaceReject536 _writer)
{
    OrderCancelReplaceReject536 writer(_writer.m_buffer, _writer.m_offset,
