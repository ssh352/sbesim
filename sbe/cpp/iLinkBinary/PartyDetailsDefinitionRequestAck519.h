...
#ifndef _ILINKBINARY_PARTYDETAILSDEFINITIONREQUESTACK519_H_
#define _ILINKBINARY_PARTYDETAILSDEFINITIONREQUESTACK519_H_
...
public:
    ...
    {
        PartyDetailsDefinitionRequestAck519 skipper(m_buffer, m_offset,
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getAvgPxGroupID(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 87, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
...
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
        return m_actingVersion >= partyDetailRequestStatusSinceVersion();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
    }
...
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
        return m_actingVersion >= partyDetailDefinitionStatusSinceVersion();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
    }
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, PartyDetailsDefinitionRequestAck519 _writer)
{
    PartyDetailsDefinitionRequestAck519 writer(_writer.m_buffer, _writer.m_offset,
