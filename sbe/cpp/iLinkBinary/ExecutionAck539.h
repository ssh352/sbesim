...
#ifndef _ILINKBINARY_EXECUTIONACK539_H_
#define _ILINKBINARY_EXECUTIONACK539_H_
...
public:
    ...
    {
        ExecutionAck539 skipper(m_buffer, m_offset,
...
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
        return m_actingVersion >= execAckStatusSinceVersion();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
    }
    ...
    SBE_NODISCARD ExecAckStatus::Value execAckStatus() const SBE_NOEXCEPT
    {
        std::uint8_t val;
...
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
        return m_actingVersion >= dKReasonSinceVersion();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
    }
    ...
    SBE_NODISCARD DKReason::Value dKReason() const SBE_NOEXCEPT
    {
        char val;
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getSenderID(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 67, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
...
#pragma clang diagnostic pop
    ...
    std::uint64_t getLocation(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 95, sizeof(char) * static_cast<size_t>(length));
        return length;
    }
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, ExecutionAck539 _writer)
{
    ExecutionAck539 writer(_writer.m_buffer, _writer.m_offset,
