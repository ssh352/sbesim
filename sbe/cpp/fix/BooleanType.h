...
#ifndef _FIX_BOOLEANTYPE_H_
#define _FIX_BOOLEANTYPE_H_
...
public:
    enum Value
    {
        FIX_FALSE = (std::uint8_t)0,
        FIX_TRUE = (std::uint8_t)1,
    ...
    static const char* c_str(const BooleanType::Value value)
    {
        switch (value)
        {
            case FIX_FALSE: return "FIX_FALSE";
            case FIX_TRUE: return "FIX_TRUE";
