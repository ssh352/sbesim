...
#ifndef _FIX_INTQTY32_H_
#define _FIX_INTQTY32_H_
...
public:
    ...
    IntQty32(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        IntQty32(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    IntQty32(
        char *buffer,
        const std::uint64_t bufferLength) :
        IntQty32(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    IntQty32 &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = IntQty32(buffer, offset, bufferLength, actingVersion);
    }
...
#pragma clang diagnostic pop
    ...
    IntQty32 &mantissa(const std::int32_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, IntQty32 writer)
{
    builder << '{';
    builder << R"("mantissa": )";
