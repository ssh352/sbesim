...
#ifndef _FIX_ORDTYPE_H_
#define _FIX_ORDTYPE_H_
...
public:
    enum Value
    {
        MARKET_ORDER = (char)49,
        LIMIT_ORDER = (char)50,
        STOP_ORDER = (char)51,
        STOP_LIMIT_ORDER = (char)52,
        MARKET_LIMIT_ORDER = (char)75,
        NULL_VALUE = (char)0
    };
    ...
    static const char* c_str(const OrdType::Value value)
    {
        switch (value)
        {
            ...
            case STOP_ORDER: return "STOP_ORDER";
            case STOP_LIMIT_ORDER: return "STOP_LIMIT_ORDER";
            case MARKET_LIMIT_ORDER: return "MARKET_LIMIT_ORDER";
