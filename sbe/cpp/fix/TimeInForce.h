...
#ifndef _FIX_TIMEINFORCE_H_
#define _FIX_TIMEINFORCE_H_
...
public:
    ...
    {
        DAY = (char)48,
        GOOD_TILL_CANCEL = (char)49,
        FILL_AND_KILL = (char)51,
        GOOD_TILL_DATE = (char)54,
        NULL_VALUE = (char)0
    };
    ...
    static const char* c_str(const TimeInForce::Value value)
    {
        switch (value)
        {
            ...
            case FILL_AND_KILL: return "FILL_AND_KILL";
