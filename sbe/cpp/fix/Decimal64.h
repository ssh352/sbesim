...
#ifndef _FIX_DECIMAL64_H_
#define _FIX_DECIMAL64_H_
...
public:
    ...
    Decimal64(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        Decimal64(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    Decimal64(
        char *buffer,
        const std::uint64_t bufferLength) :
        Decimal64(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    Decimal64 &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Decimal64(buffer, offset, bufferLength, actingVersion);
    }
...
#pragma clang diagnostic pop
    ...
    Decimal64 &mantissa(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, Decimal64 writer)
{
    builder << '{';
    builder << R"("mantissa": )";
